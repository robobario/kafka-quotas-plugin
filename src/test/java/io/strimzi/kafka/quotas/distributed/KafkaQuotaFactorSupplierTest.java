...
class KafkaQuotaFactorSupplierTest {
    ...
    private MockConsumer<String, QuotaFactorUpdate> kafkaConsumer;
    ...
    void shouldAcceptUpdate() {
        ...
        kafkaConsumer.addRecord(new ConsumerRecord<>(TEST_TOPIC, 0, 0, "1", new QuotaFactorUpdate(Instant.now(), newFactor)));
    ...
    private MockConsumer<String, QuotaFactorUpdate> initialiseMockConsumer() {
        MockConsumer<String, QuotaFactorUpdate> mockConsumer = new MockConsumer<>(OffsetResetStrategy.EARLIEST);
